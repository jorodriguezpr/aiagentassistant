...
- **Up to 120 iterations** per task with configurable continuation
...
- **NL Scripts** — save multi-step natural-language procedures and replay them on demand
- **Credential vault** — encrypted at-rest credential store with `/savecred` / `/getcred`
- **Scheduled tasks** — cron-based task scheduling with `/scheduled`
...
A standalone web application running at **port 8085**, accessible from any browser.
...
|---------|-----------------|
| **AI Chat** | Full chat interface with live step indicators; identical AI experience to Telegram |
...
| **Scheduled Tasks** | View scheduled/recurring tasks |
